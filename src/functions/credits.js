...
function Credits() {
  ...
  return (
    <div>
      ...
      <ul>
        <li>
          <a href="https://github.com/coding-with-chaim/react-video-chat">
            Code
          </a>
        </li>
        <li>
          <a href="https://www.youtube.com/watch?v=BpN6ZwFjbCY">
            Video Tutorial
          </a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="https://www.youtube.com/watch?v=7a_vgmEZrhE">
            Video Tutorial
          </a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="https://stackoverflow.com/a/60125216">
      ...
      <ul>
        <li>
          <a href="https://www.digitalocean.com/community/tutorials/react-tabs-component">
            Online Tutorial
          </a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="https://jordanfeng.me">
            My Website (Feedback is always welcome) :D
          </a>
        </li>
      </ul>
